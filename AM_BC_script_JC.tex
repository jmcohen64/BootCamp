...
\begin{proof}
	Let $I = (a,b)$ and $p\in I$. This interval is open by Corollary 4.7, so there must exist an interval $I_p$ where $p\in I_p$ and $I_p\subset (a,b)$. Since both $I$ and $I_p$ are intervals containing $p$, we can define the interval $I^\prime$ containing $p$ as $I\cap I_p = I^\prime$ by Theorem 3.20. By Corollary 5.4, this interval is infinite. Thus $I\setminus\{p\}\cap I_p \not= \emptyset$. Since the choice of $p$ in $I$ was arbitrary, any point of $I$ is a limit point of $I$.
\end{proof}
