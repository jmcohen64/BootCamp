...
\begin{proof}
	Let $x$ be any element in $(a,b)$. Since this interval is the set of value such that $x<a$ and $x>b$, $a$ and $b$ satisfy the definitions of upper and lower bounds respectively. Consider any other $b^\prime > a$. %By the trichotomy property of the ordering, three relations are possible: $b<b^\prime$, $b>b^\prime$, $b=b^\prime$.
